	...
	<div id="contents">
		...
		<div class="featured">
			...
			<c:forEach var="bulletins" items="${bulletins}">
				...
				<li>
					<div class="frame1">
						<h3><b>${bulletins.head }</b> </h3>
					</div>
										<a href="duyuru_detay_islem?id=${bulletins.id }" class="more">Islem yap</a>
					
				</li>
					
			</c:forEach>
			</ul>
			<br><a href="yeni_duyuru"><img src="images/ekle.jpg" alt="Img" height="100" width="220"></a>
