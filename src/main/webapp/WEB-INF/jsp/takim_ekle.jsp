...
<body>
	...
	<div id="contents">
		 ...
		 <div id="kayitFormu">
            <form action="takim_kaydet"  name="team">
                <h3>Takim Kayit Formu</h3>
                <input type="text" name="name"  placeholder="ad" /> 
               <input type="text" name="department"  placeholder="alan"  /> 
                <input type="text" name="info"  placeholder="takim bilgisi"  />
