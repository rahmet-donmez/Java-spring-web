...
<body>
	...
	<div class="featured">
					...
					<p class="clearfix">
						...
						<b>Takim kaptani:</b> <br>
						${team.captain.first_name}<br>
						${team.captain.last_name}<br>
						${team.captain.department}<br>
						${team.captain.email}<br><br>
						kaptan islemleri:<br>
						<a href="yeni_kaptan" class="more" >ekle</a><br><br>
						<a href="kaptan_dondur" class="more" >guncelle</a><br><br>
						...
						<div class="featured">
							...
							<c:forEach var="students" items="${team.students }">
										...
										<li class="clearfix">
											...
											<a href="ogrenci_sil?id=${students.id }" class="more">sil</a>
											<a href="ogrenci_dondur?id=${students.id}" class="more">guncelle</a> 
							...
							<a href="yeni_ogrenci" class="more">Ogrenci ekle</a>
						...
						<%-- <c:forEach var="students" items="${team.students }">
						  ...
						  --%>
						  <p>takim islemleri<br></p>
						 <a href="takim_dondur" class="more">guncelle</a><br>
						<a href="takim_sil" class="more">sil</a>
