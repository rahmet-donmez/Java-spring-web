...
<body>
	...
	<div id="contents">
		...
		<div id="kayitFormu">
            <form action="kaptan_kaydet"  name="captain">
                <h3>Kaptan Kayit Formu</h3>
                <input type="text" name="first_name" placeholder="ad" value="${captain.first_name }"/> 
                <input type="text" name="last_name" placeholder="soyad" value="${captain.last_name }" /> 
                 <input type="text" name="department" placeholder="bolum" value="${captain.department }" /> 
                <input type="email" name="email" placeholder="email" value="${captain.email }" required />
