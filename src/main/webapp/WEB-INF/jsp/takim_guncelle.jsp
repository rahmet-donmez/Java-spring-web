...
<body>
	...
	<div id="contents">
		 ...
		 <div id="kayitFormu">
            <form action="takim_guncelle"  name="team">
                <h3>Takim Guncelleme Formu</h3>
                Ad:<input type="text" name="name"  value="${team.name }" /> 
                Alan:<input type="text" name="department"  value="${team.department }"  /> 
                Bilgi:<input type="text" name="info"  value="${team.info }"  />
