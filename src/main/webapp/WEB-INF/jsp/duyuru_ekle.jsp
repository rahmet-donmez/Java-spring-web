...
<body>
	...
	<div id="contents">
		 ...
		 <div id="kayitFormu">
            <form action="duyuru_kaydet"  name="bulletin">
                <h3>Duyuru Ekleme Formu</h3>
                <input type="text" name="head"  placeholder="baslik" /> 
               <input type="text" name="texts"  placeholder="icerik"  /> 
