...
<body>
	...
	<div id="contents">
		...
		<div id="kayitFormu">
            <form action="ogrenci_guncelle"  name="student">
                <h3>Ogrenci Guncelleme Formu</h3>
                Ad:<input type="text" name="first_name" value="${student.first_name }" /> 
                Soyad:<input type="text" name="last_name" value="${student.last_name }"  /> 
                Bolum:<input type="text" name="department" value="${student.department }"  /> 
